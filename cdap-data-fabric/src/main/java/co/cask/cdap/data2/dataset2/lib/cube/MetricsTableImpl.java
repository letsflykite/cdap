 ...
 *
 */
public class MetricsTableImpl implements MetricsTable {
  private final Table table;

  public MetricsTableImpl(Table table) {
    this.table = table;
  }
  ...
  public void deleteAll(byte[] prefix) throws Exception {
    // todo: the method from interface only used in unit-tests, remove it from interface and from here
  }
  ...
  @Override
  public void deleteRange(@Nullable byte[] start, @Nullable byte[] stop,
                          @Nullable byte[][] columns, @Nullable FuzzyRowFilter filter) throws Exception {
    // todo: implement
  }
